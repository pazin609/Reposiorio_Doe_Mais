...
<html lang="pt-br">
  <head>  
    ...
    <link rel="stylesheet" href="../Páginas CSS/postagens.css"/>
    <script src="../Páginas JS/postagens.js" defer></script>
        ...
        <nav class="nav-bar">
          <a href="../index.html"><img src="../Imagens/DOE MAIS.png" class="menu-logo" draggable="false"></a>
             ...
             <div class="login-button">
                <button class="login-button-menu-3"><a href="../Paginas Html/index.php">Login</a></button>
             </div>
